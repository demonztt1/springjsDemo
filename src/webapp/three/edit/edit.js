import magicCubeHtml from  './edit.html'
...
function createData(){
    ...
    for(let i=0;i<10000;i++){
        ...
        solid[i].position.x =   parseInt ((i%10)%10) *21;
        solid[i].position.y =  -parseInt(i/10) *21;
        solid[i].position.z =   21;
    }
};
//生成材质
