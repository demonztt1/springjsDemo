import userList  from './addUserEdit.html'
...
class EditableTable extends React.Component {
    ...
    ok = e =>{
        let _this=this;
        let {selectedRowKeys ,orgId}=_this.state
        let userIds=selectedRowKeys;
        let params = {userIds,orgId}
        instance.post('/org/userSave',params)
            .then((resdata) => {
                top.close(1);
            })
            .catch(error => {
    ...
    findData(){
        ...
        instance.post('/org/userList',params) .then((data) => {
            //此处为正常业务数据的处理
