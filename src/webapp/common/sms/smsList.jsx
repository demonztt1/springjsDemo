    ...
    constructor(props) {
        ...
        this.columns = [
            {dataIndex:'id',title:'序号',width:120,                    editable: false},
                {dataIndex:'toId',title:'发送人id',width:120,                    editable: false},

            {dataIndex:'fromId',title:'收件人id',width:120,                    editable: false},

            {dataIndex:'toName',title:'发送人名称',width:250,                    editable: false,},

            {dataIndex:'fromName',title:'收件人名称',width:250,                    editable: false,},

            {dataIndex:'sms',title:'消息',width:250,                    editable: false,},

            {dataIndex:'link',title:'链接',width:250,                    editable: false,},

            {dataIndex:'instanceId',title:'工作流实例ID',width:250,                    editable: false,},
...
//获取数据
    ...
    menu= (event,record) =>{
        this.setState({event:event,
            visible: true,index:record.index,
            indexRecord:record
        })
    }
    ...
    start =()=>{
        let _this=this;
        const  {index,instanceId,link}=this.state.indexRecord;

        _this.setState({
            workVisible: true,
            url:link ,
            paramObj:{instanceId:instanceId}
        })
