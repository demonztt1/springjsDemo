...
doc.pipe(fs.createWriteStream('test/com/pdf/out.pdf'));
...
doc.registerFont('Palatino', 'test/com/pdf/fonts/PalatinoBold.ttf');
...
doc
    ...
    .image('test/com/pdf/images/test.png', 100, 160, {
        width: 412
    })
    .image('test/com/pdf/images/test.jpeg', 190, 400, {
        height: 300
    });
...
//添加书签就是菜单
const { outline }  = doc;
const top1 = outline.addItem('少时诵诗书所所所所所所所', { expanded: true });
...
doc
    .fillColor('#000')
    .font('test/com/pdf/fonts/Chalkboard.ttc', 'Chalkboard', 16)
...
// Add a top-level bookmark
// Add a top-level bookmark
const top = outline.addItem('http://baidu.com/', { expanded: true });

// Add a sub-section 添加子菜单
